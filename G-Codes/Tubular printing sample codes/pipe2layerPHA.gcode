;Alessandro Zedgitt
;2023-08-23 14:02:19.973418
;Pattern = channel
;Length = 15   Repetitions = 1
;Layers = 2   Spacing = 0.5
...
G4 P0.009805569294736605; wait 0.009805569294736605ms 
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
G4 P0.009805569294736605; wait 0.009805569294736605ms 
MANUAL_STEPPER STEPPER=stepper_1 MOVE=9 SPEED=25.132741228718345 ACCEL=100 SYNC=0; turns the mandrel for 360° 
G1 F800 
G1 X17.0 Y41.5 Z2.5
G4 P1.7622573036238813; waits for the jetlag to diminish 
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
...
G1 X40 Y41.5 Z2.5
G4 P0.018027313727830445; waits for the jetlag to diminish 
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
MANUAL_STEPPER STEPPER=stepper_1 MOVE=1.0 SPEED=533.3333333333334 ACCEL=100
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
G4 P0.018027313727830445; waits for the jetlag to diminish 
G1 X25 Y41.5 Z2.5
G4 P0.018027313727830445; waits for the jetlag to diminish 
...
G1 F800
G1 X25 Y41.5 Z2.5
MANUAL_STEPPER STEPPER=stepper_1 MOVE=9 SPEED=8.377580409572781 ACCEL=100 SYNC=0; turns the mandrel for 360° 
G1 F800 
G1 X39.32394487827058 Y41.5 Z2.5
G4 P0.009812019686179457; wait 0.009812019686179457ms 
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
G4 P0.009812019686179457; wait 0.009812019686179457ms 
MANUAL_STEPPER STEPPER=stepper_1 MOVE=9 SPEED=8.377580409572781 ACCEL=100 SYNC=0; turns the mandrel for 360° 
G1 F800 
G1 X25.0 Y41.5 Z2.5
G4 P9.15695755765769; waits for the jetlag to diminish 
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
MANUAL_STEPPER STEPPER=stepper_1 MOVE=3.0 SPEED=8.377580409572781 ACCEL=100
MANUAL_STEPPER STEPPER=stepper_1 SET_POSITION=0 
G4 P9.15695755765769; waits for the jetlag to diminish 
MANUAL_STEPPER STEPPER=stepper_1 MOVE=9 SPEED=8.377580409572781 ACCEL=100 SYNC=0; turns the mandrel for 360° 
G1 F800 
