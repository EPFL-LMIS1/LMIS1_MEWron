...
Qv=FLOWRATE/DENSITY #Volume flow rate of the fiber
...
THETA=350 # Angle coverage for the cuff,  >180 and <360
PIVOT_points = 9 #points at which pivoting happens when mandrel rotates by THETA